...
export default function SystemPage() {
  ...
  // Dashboard URLs
  const dashboards = {
    node: "https://grafana.tersaphir.fr/d/rYdddlPWk/node-exporter-dashboard?orgId=1&kiosk=1&theme=light",
    docker: "https://grafana.tersaphir.fr/d/pMEd7m0Mz/cadvisor-dashboard?orgId=1&kiosk=1&theme=light",
    kafka: "https://grafana.tersaphir.fr/d/jwPKIsniz/kafka-dashboard?orgId=1&kiosk=1&theme=light",
  };
